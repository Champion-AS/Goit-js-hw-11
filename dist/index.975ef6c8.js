...
let searchValue = "";
const totalPages = Math.ceil(12.5);
formEl.addEventListener("submit", onSubmit);
async function loadMoreCards(searchValue1) {
    page += 1;
    const data = await (0, _apiWep.getPhoto)(searchValue1, page);
    createGalleryMarkup(data.hits);
    if (page === totalPages) moreBtn.classList.add("visually-hidden");
    doLightbox();
}
...
async function mountData(searchValue2) {
    try {
        const data = await (0, _apiWep.getPhoto)(searchValue2, page);
        ...
        if (data.hits.length === 0) (0, _notiflixDefault.default).Notify.failure("Sorry, there are no images matching your search query. Please try again.");
        else (0, _notiflixDefault.default).Notify.info(`Hooray! We found ${data.totalHits} images.`);
        createGalleryMarkup(data.hits);
        doLightbox();
    } catch (error) {
...
function doLightbox() {
    ...
    let lightbox = new (0, _simplelightboxDefault.default)(".photo-card a", {
        captionDelay: 250,
        captionsData: "alt"
    });
}
...
},{"./css/styles.css":"1CY4s","./ApiWep":"cIGJX","notiflix":"5WWYd","simplelightbox":"9ydBq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","simplelightbox/dist/simple-lightbox.min.css":"kaxSc"}],"1CY4s":[function() {},{}],"cIGJX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
async function getPhoto(search, page) {
    try {
        ...
        const response = await (0, _axiosDefault.default).get(`${BASE_URL}&page=${page}&q=${search}`);
...
},{"./../utils":"5By4s"}],"5WWYd":[function(require,module,exports) {
var global = arguments[3];
